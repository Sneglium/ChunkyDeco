...
local function make_connected_table (name, description, top_box, leg_box, strut_box, texname_override, special_group)
	...
	register_table_node(name, 0, description, {type = 'fixed', fixed = box_0}, texname_override, special_group)
	...
	register_table_node(name, 1, description, {type = 'fixed', fixed = box_1}, texname_override, special_group)
	...
	register_table_node(name, 2, description, {type = 'fixed', fixed = box_2}, texname_override, special_group)
	
	local box_3 = {}
	chunkydeco.unpack_and_inject(box_3, top_box)

	register_table_node(name, 3, description, {type = 'fixed', fixed = box_3}, texname_override, special_group)
end
